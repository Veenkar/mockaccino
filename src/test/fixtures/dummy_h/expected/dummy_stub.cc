...
int dummy(const SomeType_T, char[])
{
	DUMMY_STUB_PRINT_INFO();
	return static_cast<int>(0);
}

void dummy2(const SomeType_T, char[])
{
	DUMMY_STUB_PRINT_INFO();
}

int dummy3(const SomeType_T, char[])
{
	DUMMY_STUB_PRINT_INFO();
	return static_cast<int>(0);
}

int * dummy4(const SomeType_T, char[])
{
	DUMMY_STUB_PRINT_INFO();
	return nullptr;
}

const int main2(const int, char[])
{
	DUMMY_STUB_PRINT_INFO();
